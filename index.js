  ...
  try {
    ...
    if (!user) {
      ...
      let mailOptions = {
        ...
        to: req.body.email,
        subject: "Reset Password OTP | ChatApp",
        text: `Hello user,\nYour OTP is : ${otp}\nEnter this code within 1 hour to reset your password. If you do not recognize or expect this mail, please ignore it.\n\nChatApp`,
      };
    ...
    res.status(400).json({ error: { email: "Error sending OTP" } });
  }
});
